...
Public Class frmCrediario1
    ...
    Private Sub frmCrediario1_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub dtVen_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles dtVen.Leave
        If Validar(Me.txtValCred) = False Then Exit Sub
        If Validar(Me.dtVen) = False Then Exit Sub
        If Validar(Me.txtDias) = False Then Exit Sub
        GerarParecelas()
