...
Public Class clsControlidSatDLL
    <DllImport("dllsatcontrolid.dll", CallingConvention:=CallingConvention.Cdecl)> _
   ...
   Public Shared Function AtualizarSoftwareSAT(ByVal nSessionRandom As Int32, ByVal codigoDeAtivacao As String) As IntPtr
    End Function
    Public Shared Function Base64ToAscii2(ByVal parString As String, ByVal parNivel As Integer) As String
